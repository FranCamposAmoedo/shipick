...
const Us = () => {
  return (
    <section id="us">
      ...
      <div id="carouselExampleControls" className="carousel slide img-us" data-bs-ride="carousel">
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src="../images/pictures/foto_nosotros1.png" className="d-block w-100" alt="Trabajadores de Shipick" />
    </div>
    <div className="carousel-item">
      <img src="../images/pictures/foto_nosotros2.png" className="d-block w-100" alt="Choferes de Shipick" />
    </div>
  </div>
  ...
  <button className="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    ...
    <span className="visually-hidden">Next</span>
        ...
        <div className="us-bar">
          ...
          <a className="btn-home" href="#home"><img src="../images/icons/icono_flechaNegra.png" alt="Flecha Negra" /></a>
        </div>
      </div>
    </section>
  );
